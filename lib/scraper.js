...
async function quotes() {
  return new Promise( async (resolve, reject) => {
  const data = fs.readFileSync('./lib/quotes/quote.json');
...
async function quotejawa() {
  return new Promise( async (resolve, reject) => {
  const data = fs.readFileSync('./lib/quotes/quotesjawa.json');
  const jsonData = JSON.parse(data);
  const randIndex = Math.floor(Math.random() * jsonData.length);
  const randKey = jsonData[randIndex];
  console.log(randKey)
  resolve({ status: 200, author: author, result: randKey })
   }).catch((err) => {resolve(err) })
};

async function katailham() {
  return new Promise( async (resolve, reject) => {
  const data = fs.readFileSync('./lib/quotes/katailham.json');
  const jsonData = JSON.parse(data);
  const randIndex = Math.floor(Math.random() * jsonData.length);
  const randKey = jsonData[randIndex];
  console.log(randKey)
...
async function bucin() {
  return new Promise( async (resolve, reject) => {
  const data = fs.readFileSync('./lib/quotes/bucin.json');
  const jsonData = JSON.parse(data);
  const randIndex = Math.floor(Math.random() * jsonData.length);
  const randKey = jsonData[randIndex];
  console.log(randKey)
...
async function quotebucin() {
  return new Promise( async (resolve, reject) => {
  const data = fs.readFileSync('./lib/quotes/katabucin.json');
  const jsonData = JSON.parse(data);
  const randIndex = Math.floor(Math.random() * jsonData.length);
  const randKey = jsonData[randIndex];
  console.log(randKey)
...
async function gombal() {
  return new Promise( async (resolve, reject) => {
  const data = fs.readFileSync('./lib/quotes/gombalan.json');
  const jsonData = JSON.parse(data);
  const randIndex = Math.floor(Math.random() * jsonData.length);
  const randKey = jsonData[randIndex];
  console.log(randKey)
...
async function quotegalau() {
  return new Promise( async (resolve, reject) => {
  const data = fs.readFileSync('./lib/quotes/katagalau.json');
  const jsonData = JSON.parse(data);
  const randIndex = Math.floor(Math.random() * jsonData.length);
  const randKey = jsonData[randIndex];
  console.log(randKey)
...
async function quotedilan() {
  return new Promise( async (resolve, reject) => {
  const data = fs.readFileSync('./lib/quotes/dilan.json');
  const jsonData = JSON.parse(data);
  const randIndex = Math.floor(Math.random() * jsonData.length);
  const randKey = jsonData[randIndex];
  console.log(randKey)
...
async function asupan() {
  return new Promise( async (resolve, reject) => {
  const data = fs.readFileSync('./lib/asupan/asupan.json');
  const jsonData = JSON.parse(data);
  const randIndex = Math.floor(Math.random() * jsonData.length);
  const randKey = jsonData[randIndex];
  console.log(randKey)
...
module.exports = { pinterest, wallpaper, wikimedia, porno, hentai, quotesAnime, igstalk, aiovideodl, umma, ringtone, styletext, xnxxsearch, xnxxdl, quotes, quotejawa, katailham, bucin, quotebucin, gombal, quotegalau, quotedilan, ttp, gore, asupan }
